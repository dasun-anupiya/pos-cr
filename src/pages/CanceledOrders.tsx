          ...
          <Table>
            <TableHead>
              <TableRow>
                ...
                <TableCell>{t('orders:canceledOrders.cancellationDate')}</TableCell>
                <TableCell>{t('orders:canceledOrders.cancellationReason')}</TableCell>
            ...
            {selectedOrder && (
              <Box sx={{ mt: 2 }}>
                ...
                <Box sx={{ mb: 3 }}>
                  ...
                  <Typography><strong>{t('orders:canceledOrders.cancellationDate')}:</strong> {selectedOrder.cancellationDate}</Typography>
                  <Typography><strong>{t('orders:canceledOrders.cancellationReason')}:</strong> {selectedOrder.cancellationReason}</Typography>
