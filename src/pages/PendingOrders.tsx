      ...
      >
                ...
                <TableRow key={order.id}>
                  ...
                  <TableCell align="center">
                    ...
                    <IconButton
                      ...
                      color="info"
                      title={t('orders:pendingOrders.markAsProcessing')}
                    >
                      <ProcessIcon />
                    </IconButton>
                    <IconButton
                      ...
                      color="success"
                      title={t('orders:pendingOrders.markAsCompleted')}
                    >
                      <CompleteIcon />
                    </IconButton>
                    <IconButton
        ...
        >
          ...
          <DialogActions>
            ...
            <Button
              onClick={() => handleMarkAsProcessing(selectedOrder!.id)}
              color="info"
              variant="contained"
              startIcon={<ProcessIcon />}
            >
              {t('orders:pendingOrders.markAsProcessing')}
            </Button>
            <Button
            ...
            >
              {t('orders:pendingOrders.markAsCompleted')}
            </Button>
